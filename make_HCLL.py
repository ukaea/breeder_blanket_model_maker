...
for module in module_filenames:
    ...
    HCLL_blanket_geometry_parameters =  {
    ...
    #generated_detailed_module = HCLL_detailed_module(HCLL_blanket_parameters)    

    list_of_compressed_arguments.append(HCLL_blanket_geometry_parameters)
